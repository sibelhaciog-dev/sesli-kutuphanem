...
Her önemli teknik karar burada bir dosya olarak durur. Amaç, altı ay sonra
"bu neden böyle yapılmış?" sorusunun cevabını bulabilmek.

Yeni karar alındığında sıradaki numarayı kullanarak yeni bir dosya ekleyin;
